...
public class MLTDocumentClassifier_III_Test{
    
    public MLTDocumentClassifier_III_Test(){
    }
     ...
     */
    @Test
    public void testClassify(TestContext context){
        ...
        try
        {
            ...
            //booleanQuery.add(user,BooleanClause.Occur.MUST);
            
            // That's to stop Netty sending log messages.
            InternalLoggerFactory.setDefaultFactory(JdkLoggerFactory.INSTANCE);
            
            Async async = context.async();
            
            VertxOptions options = new VertxOptions().setBlockedThreadCheckInterval(2000000000);
